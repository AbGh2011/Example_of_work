...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('blog', '0002_alter_user_options_alter_user_groups_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_posts', to='blog.user', verbose_name='نویسنده')),
            ],
            options={
                'verbose_name': 'پست',
